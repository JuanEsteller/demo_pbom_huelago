...
map.getView().fit([-370796.448867, 4493269.346531, -357392.147597, 4501832.580970], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">DEMO PBOM HUÉLAGO</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (140 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Demo Plan Básico de Ordenación Municipal.<br />Fase: Avance<br />Modelo General de Ordenación del Territorio. Clasificación del suelo Urbano y Rústico';
            }

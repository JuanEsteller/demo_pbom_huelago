...
lyr_Ortoimagen_0.setVisible(true);lyr_Callejero_1.setVisible(true);lyr_SueloRstico_2.setVisible(true);lyr_SueloUrbano_3.setVisible(true);lyr_HulagoTM_4.setVisible(true);lyr_Catastro_5.setVisible(true);
